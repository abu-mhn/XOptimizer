...
- Scoreboard scoring on any device — on mobile, tapping Scoreboard rotates the phone to landscape for you (Android Chromium; iPhone Safari has no orientation-lock API, so there it still opens on tilt as before), or it opens as a popup on desktop with no tilt needed
