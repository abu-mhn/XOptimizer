...
- Dragon Slayer — defeat 100 opponents whose deck included a part named Dran, Drake or Dragoon, while your OWN deck contains any Knight-named part (the knight slays the dragon). Awards the "Dragon Slayer" profile tag + unlocks the Dragon Slayer theme (steel blue + silver)
...
- King of Jungle — win 100 matches with any Leon-named part in your deck (Leon Crest / Leon Claw / any Leon-prefixed blade or ratchet). Awards the "King of Jungle" profile tag + unlocks the King of Jungle theme (savanna gold + jungle green)
...
- Sorcerer Supreme — win 100 matches where exactly ONE of your 3 deck slots contains a Wizard-named part AND the OTHER two slots both classify as pure Attack-type combos. Hard-carry control with two attackers. Awards the "Sorcerer Supreme" profile tag + unlocks the Sorcerer Supreme theme (mystical violet + arcane gold)
...
- Achievement themes: Dragon Tamer (warm reds + ember gold), Dragon Slayer (steel blue + silver), Lonewolf (slate gray + moon teal), Rush Hour (deep amber + traffic-light red), King of Jungle (savanna gold + jungle green), Sharknado (ocean blue + lightning yellow) and Sorcerer Supreme (mystical violet + arcane gold). Each appears in the theme menu only while the matching achievement tag is held (awarded at 100 wins — see the Achievement tab); same demote-to-Dark behavior as the medal themes if the tag is ever lost
