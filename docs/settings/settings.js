...
- Countdown: once both are Ready the panels fade out and 3 - 2 - 1 - Go - Shoot play one word at a time over a dimmed screen, each popping in and out, with the matching voice clips. Then the board itself fades in. "Go" and "Shoot" are the two halves of the single goShoot clip, so they run tighter than the digits and only the first carries audio. A reduced-motion preference keeps the whole sequence but stops it moving
