...
- "Ready, Set" runs at speaking pace — about two seconds for the pair, then straight into the digits. It was a 7-second window at first, meant to buy time to load and aim, but that left "Set" sitting on screen for five seconds before "3" and read as the sequence having stalled. Players load during the gate, before either side taps Ready, so the phrase does not need to buy them any
