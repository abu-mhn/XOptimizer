...
- King of Jungle — win 100 matches where exactly ONE deck slot carries a Leon-named part (the lion king) AND the OTHER two slots each carry at least one part named Rhino, Fox, Wolf, Viper, Tiger, Bear or Goat (the pride that flanks him). Awards the "King of Jungle" profile tag + unlocks the King of Jungle theme (savanna gold + jungle green)
