...
- Placement depth applies to every knockout, not just the elimination formats: a Swiss or Round Robin room that cuts to a bracket is asked for it at create time (right after the bracket size) and shows a "Ranks top N" chip on the registration screen. So a Top 8 cut can decide only 1st–4th — the 5th/7th consolation matches simply aren't created. Defaults to the cut size, i.e. rank everyone who made the bracket
...
- Registrant list tools (host / co-host): a search box filters players by name, and a sort toggle orders the list by name (A–Z / Z–A) or registration time (oldest / newest). A row filter narrows to All / No Deck / Banned Parts / Incomplete / Deck, plus Paid / Unpaid for a Keeper; all combine with the search
