...
- Lonewolf — win 100 matches where (1) your deck contains exactly one Wolf-named part AND (2) the slot holding that Wolf part is the only one of its combo type in the deck (Balance variants count as one type). If the Wolf slot is Stamina, neither other slot can be Stamina, etc. — the wolf walks its own type. Awards the "Lonewolf" profile tag + unlocks the Lonewolf theme (slate gray + moon teal)
